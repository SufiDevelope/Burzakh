...
class PasswordInfoDialog extends StatelessWidget {
  PasswordInfoDialog({super.key});
  @override
      ...
      child: Dialog(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Center(child: AppText(text: "Password Requirements",fontSize: heading2,fontWeight: FontWeight.w600,color: AppColor.black(),fontFamily: 'ns',)),
              SizedBox(height: commonHeightS,),
              AppText(text:
                  '- At least 8 characters\n'
                  '- At least one uppercase letter (A–Z)\n'
                  '- At least one number (0–9)\n'
                  '- At least one special character (e.g. !, @, #, \$)',fontFamily: 'nr',color: AppColor.grey(),),
