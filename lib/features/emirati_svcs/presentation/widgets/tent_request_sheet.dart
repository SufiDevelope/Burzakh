...
class TentRequestSheet extends StatefulWidget {
   TentRequestSheet({super.key});

  @override
  State<TentRequestSheet> createState() => _TentRequestSheetState();
}

class _TentRequestSheetState extends State<TentRequestSheet> {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(child: AppText(text: "Request Community Development Authority Service",fontSize: heading2,textAlign: TextAlign.center,fontWeight: FontWeight.w600,color: AppColor.black(),fontFamily: 'ns',)),
                     SizedBox(),
                    ],
                  ),
                  ...
                  SizedBox(height: 5,),
                  CustomTextFormField(borderColor: AppColor.fieldYellowBorder(), hintTextStyle: AppTextStyle.hintTextStyleWithFont(),controller: timeController,onTap: () async{
                  ...
                  if(response=="200"){
                    ...
                    },heading: "Mourning tent request sent", subText1: "Your request has been shared with the Community Development Authority.", subText2: "You may cancel this request within 2 hours."),);
                  }
                    },isLoading: _emiratiScvCubit.isCdaLoading ||_emiratiScvCubit.isGetCdaLoading, text: "SUBMIT",textColor: AppColor.white(),fontWeight: FontWeight.w600,),
