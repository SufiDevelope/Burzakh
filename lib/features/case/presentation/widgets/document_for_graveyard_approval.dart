...
import '../../../home/data/model/graveyard_case_process_model.dart';

class DocumentForGraveyardApproval extends StatelessWidget {
   DocumentForGraveyardApproval({super.key,required this.model});
  GraveyardCaseProcessModel model;
  @override
      ...
      child:Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Expanded(child: AppText(text: "Passport/EID of deceased",fontSize: text1,color: AppColor.grey(),fontFamily: 'nr',)),
              AppText(text: model.passportOrEmirateIdFrontStatus=="pending"? "Pending":"Approved",fontSize: heading3,color: AppColor.black(),fontFamily: 'ns',),
          ...
          Row(
            ...
            children: [
              ...
              AppText(text: model.policeApprovel=="pending"? "Pending":"Approved",fontSize: heading3,color: AppColor.black(),fontFamily: 'ns',),
