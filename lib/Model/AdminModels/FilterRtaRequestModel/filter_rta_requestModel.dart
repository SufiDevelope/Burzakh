class FilterRtaRequestModel {
  String? message;
  int? count;
  List<FilterRtaData>? data;

  FilterRtaRequestModel({this.message, this.count, this.data});

  FilterRtaRequestModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    count = json['count'];
    if (json['data'] != null) {
      data = <FilterRtaData>[];
      json['data'].forEach((v) {
        data!.add(new FilterRtaData.fromJson(v));
      });
    }
  }
...
class FilterRtaData {
  ...
  FilterRtaData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
