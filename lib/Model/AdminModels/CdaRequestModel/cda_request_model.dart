class CdaRequestModel {
  String? message;
  int? pendingCount;
  int? approvedCount;
  int? rejectedCount;
  int? todayTent;
  List<CdaAllRequest>? allRequests;
  ...
  CdaRequestModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    pendingCount = json['PendingCount'];
    approvedCount = json['ApprovedCount'];
    rejectedCount = json['RejectedCount'];
    todayTent = json['TodayTent'];
    if (json['AllRequests'] != null) {
      allRequests = <CdaAllRequest>[];
      json['AllRequests'].forEach((v) {
        allRequests!.add(new CdaAllRequest.fromJson(v));
      });
    }
  }
...
class CdaAllRequest {
  ...
  CdaAllRequest.fromJson(Map<String, dynamic> json) {
    id = json['id'];
